...
class HomeDrawer extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final hiddenButtons = ref
        ...
        .hiddenDrawerButtons
        .toSet();
    bool isVisible(DrawerButtonKey key) => !hiddenButtons.contains(key.name);
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    const Divider(),
                    if (isVisible(DrawerButtonKey.search))
                      ListTile(
                    ...
                    if (isVisible(DrawerButtonKey.announcements))
                      ListTile(
                        leading: Consumer(
                          builder: (ctx, ref, _) {
                            final accountId =
                    ...
                    const Divider(),
                    if (isVisible(DrawerButtonKey.directMessages))
                      ListTile(
                        leading: Consumer(
                          builder: (ctx, ref, _) {
                            final accountId =
                    ...
                    if (isVisible(DrawerButtonKey.drive))
                      ListTile(
                    ...
                    if (isVisible(DrawerButtonKey.drafts))
                      ListTile(
                    ...
                    if (isVisible(DrawerButtonKey.clips))
                      ListTile(
                    ...
                    if (isVisible(DrawerButtonKey.lists))
                      ListTile(
                    ...
                    if (isVisible(DrawerButtonKey.antennas))
                      ListTile(
                    ...
                    if (isVisible(DrawerButtonKey.favorites))
                      ListTile(
                    ...
                    if (isVisible(DrawerButtonKey.channels))
                      ListTile(
                    ...
                    if (isVisible(DrawerButtonKey.pages))
                      ListTile(
                    ...
                    if (isVisible(DrawerButtonKey.gallery))
                      ListTile(
